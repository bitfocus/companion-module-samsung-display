	...
	action(action) {
		...
		switch (action.action) {
			case 'sendCustom':
				...
				break
			case 'powerOn':
				cmd = Buffer.from(0xAA, 0x11,0x01,0x01,0x01,0x14,0xAA,0x11,0xFE,0x01,0x01,0x11)
				end = action.options.id_end
				break
			case 'powerOff':
				cmd = Buffer.from(0xAA,0x11,0x01,0x01,0x00,0x13,0xAA,0x11,0xFE,0x01,0x00,0x10)
				end = action.options.id_end
				break
		}
